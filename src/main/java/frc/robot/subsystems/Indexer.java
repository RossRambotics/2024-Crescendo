...
public class Indexer extends SubsystemBase {
  private final CANSparkMax m_topMotorR = new CANSparkMax(Constants.kRio_CAN_Indexer_Top_Motor, MotorType.kBrushless);
  private final CANSparkMax m_topMotorL = new CANSparkMax(Constants.kRio_CAN_Indexer_Bottom_Motor,
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("indexerTopRPM", m_topMotorR.getEncoder().getVelocity());
    SmartDashboard.putNumber("indexerBottomRPM", m_topMotorL.getEncoder().getVelocity());
  ...
  public void stop() {
    m_topPIDControllerR.setReference(0, CANSparkMax.ControlType.kVelocity);
    m_topPIDControllerL.setReference(0, CANSparkMax.ControlType.kVelocity);
  }
  ...
  public void shoot() {
    ...
    m_topPIDControllerR.setReference(setPointtop, CANSparkMax.ControlType.kVelocity);
    m_topPIDControllerL.setReference(setPointtop, CANSparkMax.ControlType.kVelocity);
  }

  public void intake() {
    double setPoint = -2 * 2500;

    m_topPIDControllerR.setReference(setPoint, CANSparkMax.ControlType.kVelocity);
    m_topPIDControllerL.setReference(setPoint, CANSparkMax.ControlType.kVelocity);
  }
  ...
  public double getTopMotorSpeed() {
    return m_topMotorR.getEncoder().getVelocity();
  }

  public double getBottomMotorSpeed() {
    return m_topMotorL.getEncoder().getVelocity();
  }
