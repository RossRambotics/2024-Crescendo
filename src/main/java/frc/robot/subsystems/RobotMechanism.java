...
public class RobotMechanism extends SubsystemBase {
    ...
    public void periodic() {
        ...
        // SmartDashboard.putData("Indexer.Reverse", new
        // frc.robot.commands.Indexer.Reverse().repeatedly());
        // SmartDashboard.putData("Indexer.Stop", new
        // frc.robot.commands.Indexer.Stop());
        // SmartDashboard.putData("Indexer.Intake", new
        // frc.robot.commands.Indexer.Intake().repeatedly());
        // SmartDashboard.putData("Indexer.Retract", new
        // frc.robot.commands.Indexer.Retract());
        // SmartDashboard.putData("Indexer.Storage", new
        // frc.robot.commands.Indexer.StoreOneNote());
        // SmartDashboard.putData("Shooter.Start", new
        // frc.robot.commands.Shooter.Start());
        // SmartDashboard.putData("Shooter.Stop", new
        // frc.robot.commands.Shooter.Stop());
        // SmartDashboard.putData("Shooter.Reverse", new
        // frc.robot.commands.Shooter.Reverse());
        // SmartDashboard.putData("Intake.IntakeStart", new
        // frc.robot.commands.Intake.IntakeStart());
        // SmartDashboard.putData("Intake.IntakeStop", new
        // frc.robot.commands.Intake.IntakeStop());
        // SmartDashboard.putData("Intake.IntakeReverse", new
        // frc.robot.commands.Intake.IntakeReverse());
        // SmartDashboard.putData("Intake.IntakeUp", new
        // frc.robot.commands.Intake.Up());
        ...
        // SmartDashboard.putData("Intake.IntakeStop", new
        // frc.robot.commands.Intake.IntakeStop());
        // SmartDashboard.putData("Speaker.Middle", new
        // frc.robot.commands.Speaker.Middle());
        // SmartDashboard.putData("Speaker.Right", new
        // frc.robot.commands.Speaker.Right());
        // SmartDashboard.putData("Speaker.Left", new
        // frc.robot.commands.Speaker.Left());
        // SmartDashboard.putData("Amp.Shoot", new frc.robot.commands.Amp.Shoot());
        // SmartDashboard.putData("LClimbDown", new
        // frc.robot.commands.LClimb.LClimbDown());
        // SmartDashboard.putData("LClimbUp", new frc.robot.commands.LClimb.LClimbUp());
        // SmartDashboard.putData("LClimbStop", new
        // frc.robot.commands.LClimb.LClimbStop());
        // SmartDashboard.putData("RClimbDown", new
        // frc.robot.commands.RClimb.RClimbDown());
        // SmartDashboard.putData("RClimbUp", new frc.robot.commands.RClimb.RClimbUp());
        // SmartDashboard.putData("RClimbStop", new
