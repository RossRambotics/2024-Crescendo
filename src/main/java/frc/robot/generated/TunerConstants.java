...
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    public static final double kSpeedAt12VoltsMps = 3.75;
    ...
    private static final double kWheelRadiusInches = 1.91578947368;

    private static final boolean kSteerMotorReversed = true;
    private static final boolean kInvertLeftSide = false;
    private static final boolean kInvertRightSide = true;

    private static final String kCANbusName = "usb";
    ...
    private static final double kFrontRightEncoderOffset = 0.329833984375;
    ...
    private static final double kBackRightEncoderOffset = 0.008544921875;
